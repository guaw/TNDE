...
"""
Word vector storage and similarity look-ups. Common model independent of the way the vectors are trained(Word2Vec, FastText, WordRank, VarEmbed etc)
...
class KeyedVectors(utils.SaveLoad):
    ...
    def wmdistance(self, document1, document2):
        ...
        model, please consider citing the following papers:
